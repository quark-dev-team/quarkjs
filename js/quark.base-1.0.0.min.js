...
f=a.type;if(a.type.indexOf("touch")==0)e=a.touches&&a.touches.length>0?a.touches[0]:a.changedTouches&&a.changedTouches.length>0?a.changedTouches[0]:a,e.type=f;if(f=="keydown"||f=="keyup"||f=="keypress")this.keyState[a.keyCode]=f;d.func!=null&&d.func.call(d.host,e);b.stop(a,!c.prevent,!c.stop)};b.stop=function(a,c,d){c||a.preventDefault();d||(a.stopPropagation(),a.stopImmediatePropagation&&a.stopImmediatePropagation())}})();
...
c);return this};b.prototype.setFrame=function(a,c){c==void 0||c>this._frames.length?c=this._frames.length:c<0&&(c=0);this._frames[c]=a;a.label&&(this._frameLabels[a.label]=a);if(a.interval==void 0)a.interval=this.interval;c==0&&this.currentFrame==0&&this.setRect(a.rect)};b.prototype.getFrame=function(a){return typeof a=="number"?this._frames[a]:this._frameLabels[a]};b.prototype.play=function(){this.paused=!1};b.prototype.stop=function(){this.paused=!0};b.prototype.gotoAndStop=function(a){this.currentFrame=
this.getFrameIndex(a);this.paused=!0};b.prototype.gotoAndPlay=function(a){this.currentFrame=this.getFrameIndex(a);this.paused=!1};b.prototype.getFrameIndex=function(a){if(typeof a=="number")return a;for(var a=this._frameLabels[a],c=this._frames,b=0;b<c.length;b++)if(a==c[b])return b;return-1};b.prototype.nextFrame=function(a){var b=this._frames[this.currentFrame];if(b.interval>0)a=this._displayedCount+a,this._displayedCount=b.interval>a?a:0;if(b.jump>=0||typeof b.jump=="string")if(this._displayedCount==
...
Quark.DOMContext){var c=this.getDrawable(a),d=c.style;d.font=this.font;d.textAlign=this.textAlign;d.color=this.color;d.width=this.width+"px";d.height=this.height+"px";c.innerHTML=this.text}b.superClass.render.call(this,a)};b.prototype.getDrawable=function(a){this.drawable==null&&this.setDrawable(Quark.createDOM("div"),!0);return this.drawable.get(this,a)};b.getFontMetrics=function(a){a=Quark.createDOM("div",{style:{font:a}});a.innerHTML='<div style="display:inline-block; width:1px; height:1px;"></div>';
document.body.appendChild(a);var b={},d=a.childNodes[0];b.height=a.offsetHeight;b.ascent=d.offsetTop+d.offsetHeight;b.descent=b.height-b.ascent;document.body.removeChild(a);return b}})();

...
this.getFrameIndex(a);this.paused=!0};b.prototype.gotoAndPlay=function(a){this.currentFrame=this.getFrameIndex(a);this.paused=!1};b.prototype.getFrameIndex=function(a){if(typeof a=="number")return a;for(var a=this._frameLabels[a],c=this._frames,b=0;b<c.length;b++)if(a==c[b])return b;return-1};b.prototype.nextFrame=function(a){var c=this._frames[this.currentFrame];if(c.interval>0)a=this._displayedCount+a,this._displayedCount=c.interval>a?a:0;if(c.jump>=0||typeof c.jump=="string")if(this._displayedCount==
0||!c.interval)return this.currentFrame=this.getFrameIndex(c.jump);return c.interval>0&&this._displayedCount>0?this.currentFrame:this.currentFrame>=this._frames.length-1?this.currentFrame=0:++this.currentFrame};b.prototype._update=function(a){var c=this._frames[this.currentFrame];c.stop?this.stop():(this.paused||this.nextFrame(this.useFrames?1:a&&a.deltaTime),this.setRect(c.rect),b.superClass._update.call(this,a))};b.prototype.render=function(a){var c=this._frames[this.currentFrame].rect;a.draw(this,
c[0],c[1],c[2],c[3],0,0,this.width,this.height)}})();
...
null)}})();
(function(){var b=Quark.Graphics=function(a){this.lineWidth=1;this.strokeStyle="0";this.lineAlpha=1;this.lineJoin=this.lineCap=null;this.miterLimit=10;this.hasFill=this.hasStroke=!1;this.fillStyle="0";this.fillAlpha=1;a=a||{};b.superClass.constructor.call(this,a);this.id=Quark.UIDUtil.createUID("Graphics");this._actions=[];this._cache=null};Quark.inherit(b,Quark.DisplayObject);b.prototype.lineStyle=function(a,c,b,e,f,h){this._addAction(["lineWidth",this.lineWidth=a||1]);this._addAction(["strokeStyle",this.strokeStyle=
c||"0"]);this._addAction(["lineAlpha",this.lineAlpha=b||1]);if(e!=void 0)this._addAction(["lineCap",this.lineCap=e]);if(f!=void 0)this._addAction(["lineJoin",this.lineJoin=f]);if(h!=void 0)this._addAction(["miterLimit",this.miterLimit=h]);this.hasStroke=!0;return this};b.prototype.beginFill=function(a,b){this._addAction(["fillStyle",this.fillStyle=a]);this._addAction(["fillAlpha",this.fillAlpha=b||1]);this.hasFill=!0;return this};b.prototype.endFill=function(){this.hasStroke&&this._addAction(["stroke"]);

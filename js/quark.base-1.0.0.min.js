...
0||!b.interval)return this.currentFrame=this.getFrameIndex(b.jump);return b.interval>0&&this._displayedCount>0?this.currentFrame:this.currentFrame>=this._frames.length-1?this.currentFrame=0:++this.currentFrame};b.prototype.getNumFrames=function(){return this._frames.length};b.prototype._update=function(a){this._frames[this.currentFrame].stop?this.stop():(this.paused||(this.nextFrame(this.useFrames?1:a&&a.deltaTime),this.setRect(this._frames[this.currentFrame].rect)),b.superClass._update.call(this,
a))};b.prototype.render=function(a){var b=this._frames[this.currentFrame].rect;a.draw(this,b[0],b[1],b[2],b[3],0,0,this.width,this.height)}})();

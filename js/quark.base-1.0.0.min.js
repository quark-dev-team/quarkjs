...
(function(b){function a(a,c,d){for(var b=a.length,i=c.length,j,k,p,q,o,l={x:0,y:0},m=0;m<b;m++){j=a[m];k=a[m<b-1?m+1:0];l.x=j.y-k.y;l.y=k.x-j.x;j=Math.sqrt(l.x*l.x+l.y*l.y);l.x/=j;l.y/=j;j=k=a[0].x*l.x+a[0].y*l.y;for(var n=1;n<b;n++)o=a[n].x*l.x+a[n].y*l.y,o>k?k=o:o<j&&(j=o);p=q=c[0].x*l.x+c[0].y*l.y;for(n=1;n<i;n++)o=c[n].x*l.x+c[n].y*l.y,o>q?q=o:o<p&&(p=o);j<p?(j=p-k,l.x=-l.x,l.y=-l.y):j-=q;if(j>=0)return!1;else if(j>d.overlap)d.overlap=j,d.normal.x=l.x,d.normal.y=l.y}return d}var c=b.Quark=b.Quark||
...
(this._evtHandlers[i]=[]),k=0,p=!1;k<j.length;k++){var q=j[k];if(q.target==a&&q.callback.func==d.func){trace("duplicate callback");p=!0;break}}p||(j.push({target:a,callback:d,handler:b}),a.addEventListener(i,b,!1))}};b.prototype.unregister=function(a,c,b){for(var e=0;e<c.length;e++)for(var f=c[e],h=this._evtHandlers[f],g=0;g<h.length;g++){var i=h[g];if(i.target==a&&(i.callback.func==b||b==null)){a.removeEventListener(f,i.handler);h.splice(g,1);break}}};b.prototype._onEvent=function(a,c,d){var e=a,
...
(function(){var b=Quark.Context=function(a){if(a.canvas==null)throw"Quark.Context Error: canvas is required.";this.canvas=null;Quark.merge(this,a)};b.prototype.startDraw=function(){};b.prototype.draw=function(){};b.prototype.endDraw=function(){};b.prototype.transform=function(){};b.prototype.remove=function(){}})();
...
Quark.DisplayObjectContainer){var i=a._cache||Quark.cacheObject(a);h.drawImage(i,0,0,c,b,0,0,c,b)}else a.render(e);e.endDraw();a.mask=g;arguments[0]=f;this.context.drawImage.apply(this.context,arguments)}else a._cache!=null?this.context.drawImage(a._cache,0,0):a instanceof Quark.Graphics?a._draw(this.context):(c=a.getDrawable(this),c!=null&&(arguments[0]=c,this.context.drawImage.apply(this.context,arguments)))};b.prototype.endDraw=function(){this.context.restore()};b.prototype.transform=function(a){var c=
this.context;if(a instanceof Q.Stage){if(a._scaleX!=a.scaleX)a._scaleX=a.scaleX,this.canvas.style.width=a._scaleX*a.width+"px";if(a._scaleY!=a.scaleY)a._scaleY=a.scaleY,this.canvas.style.height=a._scaleY*a.height+"px"}else(a.x!=0||a.y!=0)&&c.translate(a.x,a.y),a.rotation%360!=0&&c.rotate(a.rotation%360*Quark.DEG_TO_RAD),(a.scaleX!=1||a.scaleY!=1)&&c.scale(a.scaleX,a.scaleY),(a.regX!=0||a.regY!=0)&&c.translate(-a.regX,-a.regY);a.alpha>0&&(c.globalAlpha*=a.alpha)};b.prototype.clear=function(a,c,b,e){this.context.clearRect(a,
c,b,e)}})();
...
var f=document.createElement("style");f.textContent="@media (-webkit-transform-3d){#test3d{height:3px}}";document.head.appendChild(f);e.appendChild(a);d=a.offsetHeight===3;f.parentNode.removeChild(f);a.parentNode.removeChild(a)}Quark.supportTransform=c;Quark.supportTransform3D=d;if(c){var h=Quark.DOMContext=function(a){h.superClass.constructor.call(this,a)};Quark.inherit(h,Quark.Context);h.prototype.draw=function(a){if(!a._addedToDOM){var c=a.parent,b=a.getDrawable(this);c==null&&b.parentNode==null?
this.canvas.appendChild(b):(c=c.getDrawable(this),b.parentNode!=c&&c.appendChild(b));a._addedToDOM=!0}};h.prototype.transform=function(a){var c=a.getDrawable(this);if(a.transformEnabled||!a._addedToDOM){var d=Quark.cssPrefix,e=d+"TransformOrigin";d+="Transform";c=c.style;if(!c.display||a.propChanged("visible","alpha"))c.display=!a.visible||a.alpha<=0?"none":"";if(!c.opacity||a.propChanged("alpha"))c.opacity=a.alpha;if(!c.backgroundPosition||a.propChanged("rectX","rectY"))c.backgroundPosition=-a.rectX+
...
"MaskPosition"]=a.mask.x+"px "+a.mask.y+"px"}};h.prototype.hide=function(a){a.getDrawable(this).style.display="none"};h.prototype.remove=function(a){var c=a.getDrawable(this),b=c.parentNode;b!=null&&b.removeChild(c);a._addedToDOM=!1}}else trace("Warn: DOMContext requires css transfrom support.")})();
...
function(a){a.debug=!a.debug;a._render=a.debug?function(c){c.clear!=null&&c.clear(0,0,a.width,a.height);Quark.Stage.superClass._render.call(a,c);c=a.context.context;if(c!=null)c.save(),c.lineWidth=1,c.strokeStyle="#f00",c.globalAlpha=0.5;b(a,c);c!=null&&c.restore()}:function(c){c.clear!=null&&c.clear(0,0,a.width,a.height);Quark.Stage.superClass._render.call(a,c)}};Quark.cacheObject=function(a,c,b){var d=a.width,i=a.height,j=Quark.createDOM("canvas",{width:d,height:i}),k=new Quark.CanvasContext({canvas:j});
a.render(k);return c?(a=new Image,a.width=d,a.height=i,a.src=j.toDataURL(b||"image/png"),a):j};Quark._helpContext=new Quark.CanvasContext({canvas:Quark.createDOM("canvas")})})();
...
"_depth"];Quark.merge(this,a,!0);a.mixin&&Quark.merge(this,a.mixin,!1)};b.prototype.setDrawable=function(a){this.drawable==null?this.drawable=new Quark.Drawable(a):this.drawable.rawDrawable!=a&&this.drawable.set(a)};b.prototype.getDrawable=function(a){return this._cache||this.drawable&&this.drawable.get(this,a)};b.prototype._update=function(a){this.update(a)};b.prototype.update=function(){return!0};b.prototype._render=function(a){a=this.context||a;!this.visible||this.alpha<=0?(a.hide!=null&&a.hide(this),
this.saveState(["visible","alpha"])):(a.startDraw(),a.transform(this),this.render(a),a.endDraw(),this.saveState())};b.prototype.render=function(a){a.draw(this,0,0,this.width,this.height,0,0,this.width,this.height)};b.prototype._onEvent=function(a){var c="on"+a.type;if(this[c]!=null)this[c](a)};b.prototype.saveState=function(a){for(var a=a||this._stateList,c=this._lastState,b=0,e=a.length;b<e;b++){var f=a[b];c["last"+f]=this[f]}};b.prototype.getState=function(a){return this._lastState["last"+a]};b.prototype.propChanged=
...
0,d=a.length;b<d;b++){var e=a[b],f=e[0].toUpperCase(),e=e.substring(1).split(/,| /);e[0].length==0&&e.shift();switch(f){case "M":this._addAction(["moveTo",e[0],e[1]]);break;case "L":this._addAction(["lineTo",e[0],e[1]]);break;case "C":this._addAction(["bezierCurveTo",e[0],e[1],e[2],e[3],e[4],e[5]]);break;case "Z":this._addAction(["closePath"])}}return this};b.prototype._draw=function(a){for(var b=0,d=this._actions.length;b<d;b++){var e=this._actions[b],f=e[0],h=e.length>1?e.slice(1):null;typeof a[f]==
"function"?a[f].apply(a,h):a[f]=e[1]}};b.prototype.getDrawable=function(a){this.drawable==null&&this.setDrawable(this.toImage());return this.drawable.get(this,a)};b.prototype.cache=function(a){var b=Quark.createDOM("canvas",{width:this.width,height:this.height});this._draw(b.getContext("2d"));this._cache=b;if(a)this._cache=this.toImage();return this._cache};b.prototype.uncache=function(){this._cache=null};b.prototype.toImage=function(a){var b=this._cache||this.cache(!0);if(b instanceof HTMLImageElement)return b;
var d=new Image;d.src=b.toDataURL(a||"image/png");d.width=this.width;d.height=this.height;return d};b.prototype.clear=function(){this._actions.length=0;this._cache=null;this.lineWidth=1;this.strokeStyle="0";this.lineAlpha=1;this.lineJoin=this.lineCap=null;this.miterLimit=10;this.hasStroke=!1;this.fillStyle="0";this.fillAlpha=1};b.prototype._addAction=function(a){this._actions.push(a);return this};b._getContext=function(){var a=Quark.createDOM("canvas").getContext("2d");this._getContext=function(){return a};
return a}})();

(function(b){function a(a,c,b){for(var d=a.length,i=c.length,k,j,o,q,p,l={x:0,y:0},m=0;m<d;m++){k=a[m];j=a[m<d-1?m+1:0];l.x=k.y-j.y;l.y=j.x-k.x;k=Math.sqrt(l.x*l.x+l.y*l.y);l.x/=k;l.y/=k;k=j=a[0].x*l.x+a[0].y*l.y;for(var n=1;n<d;n++)p=a[n].x*l.x+a[n].y*l.y,p>j?j=p:p<k&&(k=p);o=q=c[0].x*l.x+c[0].y*l.y;for(n=1;n<i;n++)p=c[n].x*l.x+c[n].y*l.y,p>q?q=p:p<o&&(o=p);k<o?(k=o-j,l.x=-l.x,l.y=-l.y):k-=q;if(k>=0)return!1;else if(k>b.overlap)b.overlap=k,b.normal.x=l.x,b.normal.y=l.y}return b}var c=b.Quark=b.Quark||

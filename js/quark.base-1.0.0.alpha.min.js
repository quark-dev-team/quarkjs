...
null)}})();
(function(){var b=Quark.Graphics=function(a){a=a||{};b.superClass.constructor.call(this,a);this.id=Quark.UIDUtil.createUID("Graphics");this.lineWidth=1;this.strokeStyle="0";this.lineAlpha=1;this.lineJoin=this.lineCap=null;this.miterLimit=10;this.fillStyle="0";this.fillAlpha=1;this._actions=[];this._cache=null};Quark.inherit(b,Quark.DisplayObject);b.prototype.lineStyle=function(a,b,d,e,f,h){this._addAction(["lineWidth",this.lineWidth=a||1]);this._addAction(["strokeStyle",this.strokeStyle=b||"0"]);
...
c||"")])};b.prototype.beginPath=function(){return this._addAction(["beginPath"])};b.prototype.closePath=function(){return this._addAction(["closePath"])};b.prototype.drawRect=function(a,b,d,e){return this._addAction(["rect",a,b,d,e])};b.prototype.drawRoundRectComplex=function(a,b,d,e,f,h,g,i){this._addAction(["moveTo",a+f,b]);this._addAction(["lineTo",a+d-h,b]);this._addAction(["arc",a+d-h,b+h,h,-Math.PI/2,0,!1]);this._addAction(["lineTo",a+d,b+e-g]);this._addAction(["arc",a+d-g,b+e-g,g,0,Math.PI/
2,!1]);this._addAction(["lineTo",a+i,b+e]);this._addAction(["arc",a+i,b+e-i,i,Math.PI/2,Math.PI,!1]);this._addAction(["lineTo",a,b+f]);this._addAction(["arc",a+f,b+f,f,Math.PI,Math.PI*3/2,!1]);return this};b.prototype.drawRoundRect=function(a,b,d,e,f){return this.drawRoundRectComplex(a,b,d,e,f,f,f,f)};b.prototype.drawCircle=function(a,b,d){return this._addAction(["arc",a+d,b+d,d,0,Math.PI*2,0])};b.prototype.drawEllipse=function(a,b,d,e){if(d==e)return this.drawCircle(a,b,d);d/=2;e/=2;var f=0.5522847498307933*
d,h=0.5522847498307933*e;a+=d;b+=e;this._addAction(["moveTo",a+d,b]);this._addAction(["bezierCurveTo",a+d,b-h,a+f,b-e,a,b-e]);this._addAction(["bezierCurveTo",a-f,b-e,a-d,b-h,a-d,b]);this._addAction(["bezierCurveTo",a-d,b+h,a-f,b+e,a,b+e]);this._addAction(["bezierCurveTo",a+f,b+e,a+d,b+h,a+d,b]);return this};b.prototype.render=function(a){var c=a.context;c==null?b.superClass.render.call(this,a):this._cache!=null?c.drawImage(this._cache,0,0):this._draw(c)};b.prototype._draw=function(a){for(var b=0,
d=this._actions.length;b<d;b++){var e=this._actions[b],f=e[0],h=e.length>1?e.slice(1):null;typeof a[f]=="function"?a[f].apply(a,h):a[f]=e[1]}};b.prototype.getDrawable=function(a){this.drawable==null&&this.setDrawable(this.toImage());return this.drawable.get(this,a)};b.prototype.cache=function(a){var b=Quark.createDOM("canvas",{width:this.width,height:this.height});this._draw(b.getContext("2d"));this._cache=b;if(a)this._cache=this.toImage();return this._cache};b.prototype.uncache=function(){this._cache=

...
a.scaleX,this.canvas.style.width=a._scaleX*a.width+"px";if(a._scaleY!=a.scaleY)a._scaleY=a.scaleY,this.canvas.style.height=a._scaleY*a.height+"px"}else(a.x!=0||a.y!=0)&&b.translate(a.x,a.y),a.rotation%360!=0&&b.rotate(a.rotation%360*Quark.DEG_TO_RAD),(a.scaleX!=1||a.scaleY!=1)&&b.scale(a.scaleX,a.scaleY),(a.regX!=0||a.regY!=0)&&b.translate(-a.regX,-a.regY);a.alpha>0&&(b.globalAlpha*=a.alpha)};b.prototype.clear=function(a,b,d,e){this.context.clearRect(a,b,d,e)}})();

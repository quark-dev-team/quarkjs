(function(b){function a(a,c,d){for(var b=a.length,i=c.length,k,j,o,q,p,l={x:0,y:0},m=0;m<b;m++){k=a[m];j=a[m<b-1?m+1:0];l.x=k.y-j.y;l.y=j.x-k.x;k=Math.sqrt(l.x*l.x+l.y*l.y);l.x/=k;l.y/=k;k=j=a[0].x*l.x+a[0].y*l.y;for(var n=1;n<b;n++)p=a[n].x*l.x+a[n].y*l.y,p>j?j=p:p<k&&(k=p);o=q=c[0].x*l.x+c[0].y*l.y;for(n=1;n<i;n++)p=c[n].x*l.x+c[n].y*l.y,p>q?q=p:p<o&&(o=p);k<o?(k=o-j,l.x=-l.x,l.y=-l.y):k-=q;if(k>=0)return!1;else if(k>d.overlap)d.overlap=k,d.normal.x=l.x,d.normal.y=l.y}return d}var c=b.Quark=b.Quark||
{version:"1.0.0",global:b},d=function(){};c.inherit=function(a,c){d.prototype=c.prototype;a.superClass=c.prototype;a.prototype=new d;a.prototype.constructor=a};c.merge=function(a,c,d){for(var b in c)if(!d||a.hasOwnProperty(b)||a[b]!==void 0)a[b]=c[b];return a};c.delegate=function(a,c){var d=c||b;if(arguments.length>2){var g=Array.prototype.slice.call(arguments,2);return function(){var c=Array.prototype.concat.apply(g,arguments);return a.apply(d,c)}}else return function(){return a.apply(d,arguments)}};
c.getDOM=function(a){return document.getElementById(a)};c.createDOM=function(a,c){var d=document.createElement(a),b;for(b in c){var i=c[b];if(b=="style")for(var k in i)d.style[k]=i[k];else d[b]=i}return d};c.use=function(a){for(var a=a.split("."),c=b,d=0;d<a.length;d++)var g=a[d],c=c[g]||(c[g]={});return c};(function(a){var c=a.ua=navigator.userAgent;a.isWebKit=/webkit/i.test(c);a.isMozilla=/mozilla/i.test(c);a.isIE=/msie/i.test(c);a.isFirefox=/firefox/i.test(c);a.isChrome=/chrome/i.test(c);a.isSafari=
/safari/i.test(c)&&!this.isChrome;a.isMobile=/mobile/i.test(c);a.isOpera=/opera/i.test(c);a.isIOS=/ios/i.test(c);a.isIpad=/ipad/i.test(c);a.isIpod=/ipod/i.test(c);a.isIphone=/iphone/i.test(c)&&!this.isIpod;a.isAndroid=/android/i.test(c);a.supportStorage="localStorage"in b;a.supportOrientation="orientation"in b;a.supportDeviceMotion="ondevicemotion"in b;a.supportTouch="ontouchstart"in b;a.supportCanvas=document.createElement("canvas").getContext!=null;a.cssPrefix=a.isWebKit?"webkit":a.isFirefox?"Moz":
a.isOpera?"O":a.isIE?"ms":""})(c);c.getElementOffset=function(a){for(var c=a.offsetLeft,d=a.offsetTop;(a=a.offsetParent)&&a!=document.body&&a!=document;)c+=a.offsetLeft,d+=a.offsetTop;return{left:c,top:d}};c.createDOMDrawable=function(a,d){var b=a.tagName||"div",g=d.image,i=a.width||g&&g.width,k=a.height||g&&g.height,j=c.createDOM(b);if(a.id)j.id=a.id;j.style.position="absolute";j.style.left=(a.left||0)+"px";j.style.top=(a.top||0)+"px";j.style.width=i+"px";j.style.height=k+"px";if(b=="canvas")j.width=
i,j.height=k,g&&(b=j.getContext("2d"),i=d.rect||[0,0,i,k],b.drawImage(g,i[0],i[1],i[2],i[3],a.x||0,a.y||0,a.width||i[2],a.height||i[3]));else if(j.style.opacity=a.alpha!=void 0?a.alpha:1,j.style.overflow="hidden",g&&g.src)j.style.backgroundImage="url("+g.src+")",j.style.backgroundPosition=-(a.rectX||0)+"px "+-(a.rectY||0)+"px";return j};c.DEG_TO_RAD=Math.PI/180;c.RAD_TO_DEG=180/Math.PI;c.hitTestPoint=function(a,c,d,b){var a=a.getBounds(),i=a.length,k=c>=a.x&&c<=a.x+a.width&&d>=a.y&&d<=a.y+a.height;
if(k&&b){for(var b=0,k=!1,j,o,q,p,l=0;l<i;l++){var m=a[l],n=a[(l+1)%i];if(m.y==n.y&&d==m.y&&(m.x>n.x?(j=n.x,o=m.x):(j=m.x,o=n.x),c>=j&&c<=o)){k=!0;continue}m.y>n.y?(q=n.y,p=m.y):(q=m.y,p=n.y);d<q||d>p||(m=(d-m.y)*(n.x-m.x)/(n.y-m.y)+m.x,m>c?b++:m==c&&(k=!0))}if(k)return 0;else if(b%2==1)return 1;return-1}return k?1:-1};c.hitTestObject=function(a,d,b){a=a.getBounds();d=d.getBounds();return(a=a.x<=d.x+d.width&&d.x<=a.x+a.width&&a.y<=d.y+d.height&&d.y<=a.y+a.height)&&b?(a=c.polygonCollision(d,d),a!==
!1):a};c.polygonCollision=function(c,d){var b=a(c,d,{overlap:-Infinity,normal:{x:0,y:0}});return b?a(d,c,b):!1};c.toString=function(){return"Quark"};c.trace=function(){var a=Array.prototype.slice.call(arguments);typeof console!="undefined"&&typeof console.log!="undefined"&&console.log(a.join(" "))};if(b.Q==void 0)b.Q=c;if(b.trace==void 0)b.trace=c.trace})(window);(function(){var b=Quark.Matrix=function(a,c,d,b,f,h){this.a=a;this.b=c;this.c=d;this.d=b;this.tx=f;this.ty=h};b.prototype.concat=function(a){var c=this.a,d=this.c,b=this.tx;this.a=c*a.a+this.b*a.c;this.b=c*a.b+this.b*a.d;this.c=d*a.a+this.d*a.c;this.d=d*a.b+this.d*a.d;this.tx=b*a.a+this.ty*a.c+a.tx;this.ty=b*a.b+this.ty*a.d+a.ty;return this};b.prototype.rotate=function(a){var c=Math.cos(a),a=Math.sin(a),d=this.a,b=this.c,f=this.tx;this.a=d*c-this.b*a;this.b=d*a+this.b*c;this.c=b*c-this.d*a;this.d=
...
function(a){a.debug=!a.debug;a._render=a.debug?function(c){c.clear!=null&&c.clear(0,0,a.width,a.height);Quark.Stage.superClass._render.call(a,c);c=a.context.context;if(c!=null)c.save(),c.lineWidth=1,c.strokeStyle="#f00",c.globalAlpha=0.5;b(a,c);c!=null&&c.restore()}:function(c){c.clear!=null&&c.clear(0,0,a.width,a.height);Quark.Stage.superClass._render.call(a,c)}};Quark.displayObjectToImage=function(a,c){if(this._helpStage==null)this._helpStage=new Q.Stage({context:new Q.CanvasContext({canvas:Q.createDOM("canvas")})});
var b=a.width,d=a.height,i=a.x,k=a.y,j=this._helpStage.context,o=j.canvas;j.clear(0,0,o.width,o.height);o.width=this._helpStage.width=b;o.height=this._helpStage.height=d;a.x=0;a.y=0;j.startDraw();j.transform(a);a.render(j);j.endDraw();a.x=i;a.y=k;i=new Image;i.width=b;i.height=d;i.src=o.toDataURL(c||"image/png");return i}})();(function(){var b=Quark.Timer=function(a){this.interval=a||50;this.paused=!1;this.info={lastTime:0,currentTime:0,deltaTime:0,realDeltaTime:0};this._startTime=0;this._intervalID=null;this._listeners=[]};b.prototype.start=function(){if(this._intervalID==null){this._startTime=this.info.lastTime=this.info.currentTime=Date.now();var a=this,c=function(){a._intervalID=setTimeout(c,a.interval);a._run()};c()}};b.prototype.stop=function(){clearTimeout(this._intervalID);this._intervalID=null;this._startTime=
...
b.prototype.getChildIndex=function(a){return this.children.indexOf(a)};b.prototype.setChildIndex=function(a,b){if(a.parent==this){var d=this.children.indexOf(a);b!=d&&(this.children.splice(d,1),this.children.splice(b,0,a))}};b.prototype.swapChildren=function(a,b){var d=this.getChildIndex(a),e=this.getChildIndex(b);this.children[d]=b;this.children[e]=a};b.prototype.swapChildrenAt=function(a,b){var d=this.getChildAt(a),e=this.getChildAt(b);this.children[a]=e;this.children[b]=d};b.prototype.getChildById=
function(a){for(var b=0,d=this.children.length;b<d;b++){var e=this.children[b];if(e.id==a)return e}return null};b.prototype.removeChildById=function(a){for(var b=0,d=this.children.length;b<d;b++)if(this.children[b].id==a)return this.removeChildAt(b);return null};b.prototype.sortChildren=function(a){if(typeof a=="string")var b=a,a=function(a,e){return e[b]-a[b]};this.children.sort(a)};b.prototype.contains=function(a){return this.getChildIndex(a)!=-1};b.prototype.getNumChildren=function(){return this.children.length};
b.prototype._update=function(a){var b=!0;this.update!=null&&(b=this.update(a));if(b!==!1)for(var b=this.children.slice(0),d=0,e=b.length;d<e;d++){var f=b[d];f._depth=d+1;f._update(a)}};b.prototype.render=function(a){b.superClass.render.call(this,a);for(var c=0,d=this.children.length;c<d;c++)this.children[c]._render(a)};b.prototype.getObjectUnderPoint=function(a,b,d,e){if(e)var f=[];for(var h=this.children.length-1;h>=0;h--){var g=this.children[h];if(!(g==null||!g.eventEnabled&&g.children==void 0||
!g.visible||g.alpha<=0))if(g.children!=void 0&&g.eventChildren&&g.getNumChildren()>0){var i=g.getObjectUnderPoint(a,b,d,e);if(i)if(e)i.length>0&&(f=f.concat(i));else return i;else if(g.hitTestPoint(a,b,d)>=0)if(e)f.push(g);else return g}else if(g.hitTestPoint(a,b,d)>=0)if(e)f.push(g);else return g}return e?f:null}})();(function(){var b=Quark.Stage=function(a){this.stageY=this.stageX=0;this.paused=!1;this._eventTarget=null;a=a||{};b.superClass.constructor.call(this,a);this.id=a.id||Quark.UIDUtil.createUID("Stage");if(this.context==null)throw"Quark.Stage Error: context is required.";this.updatePosition()};Quark.inherit(b,Quark.DisplayObjectContainer);b.prototype.step=function(a){this.paused||(this._update(a),this._render(this.context))};b.prototype._update=function(a){for(var b=this.children.slice(0),d=0,e=b.length;d<
e;d++){var f=b[d];f._depth=d+1;f._update(a)}this.update!=null&&this.update(a)};b.prototype._render=function(a){a.clear!=null&&a.clear(0,0,this.width,this.height);b.superClass._render.call(this,a)};b.prototype._onEvent=function(a){var c=a.pageX||a.clientX,d=a.pageY||a.clientY,c=(c-this.stageX)/this.scaleX,d=(d-this.stageY)/this.scaleY,e=this.getObjectUnderPoint(c,d,!0),f=this._eventTarget;a.eventX=c;a.eventY=d;c=a.type=="mouseout"&&!this.context.canvas.contains(a.relatedTarget);if(f!=null&&(f!=e||
c))a.lastEventTarget=f,(d=c||e==null||a.type=="mousemove"?"mouseout":a.type=="touchmove"?"touchout":null)&&f._onEvent({type:d}),this._eventTarget=null;if(e!=null&&e.eventEnabled&&a.type!="mouseout")a.eventTarget=f=this._eventTarget=e,e._onEvent(a);if(!Quark.supportTouch)this.context.canvas.style.cursor=f&&f.useHandCursor&&f.eventEnabled?"pointer":"";(c||a.type!="mouseout")&&b.superClass._onEvent.call(this,a)};b.prototype.updatePosition=function(){var a=Quark.getElementOffset(this.context.canvas);
this.stageX=a.left;this.stageY=a.top}})();(function(){var b=Quark.Bitmap=function(a){this.image=null;this.rectHeight=this.rectWidth=this.rectY=this.rectX=0;a=a||{};b.superClass.constructor.call(this,a);this.id=a.id||Quark.UIDUtil.createUID("Bitmap");this.setRect(a.rect||[0,0,this.image.width,this.image.height]);this.setDrawable(this.image);this._stateList.push("rectX","rectY","rectWidth","rectHeight")};Quark.inherit(b,Quark.DisplayObject);b.prototype.setRect=function(a){this.rectX=a[0];this.rectY=a[1];this.rectWidth=this.width=a[2];this.rectHeight=
...
a;return this};b.prototype.setEnabled=function(a){if(this.enabled==a)return this;(this.eventEnabled=this.enabled=a)?this._skin.currentFrame==3&&this._skin.gotoAndStop(b.UP):this.disabledState?this._skin.gotoAndStop(b.DISABLED):this._skin.gotoAndStop(b.state.UP);return this};b.prototype.changeState=function(a){if(this.state!=a){this.state=a;switch(a){case b.OVER:case b.DOWN:case b.UP:if(!this.enabled)this.eventEnabled=this.enabled=!0;this._skin.gotoAndStop(a);break;case b.DISABLED:this.setEnabled(!1)}return this}};
...
0,d=a.length;b<d;b++){var e=a[b],f=e[0].toUpperCase(),e=e.substring(1).split(/,| /);e[0].length==0&&e.shift();switch(f){case "M":this._addAction(["moveTo",e[0],e[1]]);break;case "L":this._addAction(["lineTo",e[0],e[1]]);break;case "C":this._addAction(["bezierCurveTo",e[0],e[1],e[2],e[3],e[4],e[5]]);break;case "Z":this._addAction(["closePath"])}}return this};b.prototype.render=function(a){var c=a.context;c==null?b.superClass.render.call(this,a):this._cache!=null?c.drawImage(this._cache,0,0):this._draw(c)};
b.prototype._draw=function(a){for(var b=0,d=this._actions.length;b<d;b++){var e=this._actions[b],f=e[0],h=e.length>1?e.slice(1):null;typeof a[f]=="function"?a[f].apply(a,h):a[f]=e[1]}};b.prototype.getDrawable=function(a){this.drawable==null&&this.setDrawable(this.toImage());return this.drawable.get(this,a)};b.prototype.cache=function(a){var b=Quark.createDOM("canvas",{width:this.width,height:this.height});this._draw(b.getContext("2d"));this._cache=b;if(a)this._cache=this.toImage();return this._cache};
b.prototype.uncache=function(){this._cache=null};b.prototype.toImage=function(a){var b=this._cache||this.cache(!0);if(b instanceof HTMLImageElement)return b;var d=new Image;d.src=b.toDataURL(a||"image/png");d.width=this.width;d.height=this.height;return d};b.prototype.clear=function(){this._actions.length=0;this._cache=null;this.lineWidth=1;this.strokeStyle="0";this.lineAlpha=1;this.lineJoin=this.lineCap=null;this.miterLimit=10;this.hasStroke=!1;this.fillStyle="0";this.fillAlpha=1};b.prototype._addAction=
function(a){this._actions.push(a);return this};b._getContext=function(){var a=Quark.createDOM("canvas").getContext("2d");this._getContext=function(){return a};return a}})();(function(){var b=Quark.Context=function(a){if(a.canvas==null)throw"Quark.Context Error: canvas is required.";this.canvas=null;Quark.merge(this,a)};b.prototype.startDraw=function(){};b.prototype.draw=function(){};b.prototype.endDraw=function(){};b.prototype.transform=function(){};b.prototype.remove=function(){}})();(function(){var b=Quark.CanvasContext=function(a){b.superClass.constructor.call(this,a);this.context=this.canvas.getContext("2d")};Quark.inherit(b,Quark.Context);b.prototype.startDraw=function(){this.context.save()};b.prototype.draw=function(a){if(a.mask!=null)a.mask._render(this),this.context.globalCompositeOperation="source-in";var b=a.getDrawable(this);b!=null&&(arguments[0]=b,this.context.drawImage.apply(this.context,arguments))};b.prototype.endDraw=function(){this.context.restore()};b.prototype.transform=
function(a){var b=this.context;if(a instanceof Q.Stage){if(a._scaleX!=a.scaleX)a._scaleX=a.scaleX,this.canvas.style.width=a._scaleX*a.width+"px";if(a._scaleY!=a.scaleY)a._scaleY=a.scaleY,this.canvas.style.height=a._scaleY*a.height+"px"}else(a.x!=0||a.y!=0)&&b.translate(a.x,a.y),a.rotation%360!=0&&b.rotate(a.rotation%360*Quark.DEG_TO_RAD),(a.scaleX!=1||a.scaleY!=1)&&b.scale(a.scaleX,a.scaleY),(a.regX!=0||a.regY!=0)&&b.translate(-a.regX,-a.regY);a.alpha>0&&(b.globalAlpha*=a.alpha)};b.prototype.clear=
function(a,b,d,e){this.context.clearRect(a,b,d,e)}})();(function(){function b(a,b){var c="";c+=b?"translate3d("+(a.x-a.regX)+"px, "+(a.y-a.regY)+"px, 0px)rotate3d(0, 0, 1, "+a.rotation+"deg)scale3d("+a.scaleX+", "+a.scaleY+", 1)":"translate("+(a.x-a.regX)+"px, "+(a.y-a.regY)+"px)rotate("+a.rotation+"deg)scale("+a.scaleX+", "+a.scaleY+")";return c}var a=document.createElement("div"),c=a.style[Quark.cssPrefix+"Transform"]!=void 0,d=a.style[Quark.cssPrefix+"Perspective"]!=void 0,e=document.documentElement;if(d&&"webkitPerspective"in e.style){a.id="test3d";
var f=document.createElement("style");f.textContent="@media (-webkit-transform-3d){#test3d{height:3px}}";document.head.appendChild(f);e.appendChild(a);d=a.offsetHeight===3;f.parentNode.removeChild(f);a.parentNode.removeChild(a)}Quark.supportTransform=c;Quark.supportTransform3D=d;if(c){var h=Quark.DOMContext=function(a){h.superClass.constructor.call(this,a)};Quark.inherit(h,Quark.Context);h.prototype.draw=function(a){if(!a._addedToDOM){var b=a.parent,c=a.getDrawable(this);b==null&&c.parentNode==null?
this.canvas.appendChild(c):(b=b.getDrawable(this),c.parentNode!=b&&b.appendChild(c));a._addedToDOM=!0}};h.prototype.transform=function(a){var c=a.getDrawable(this);if(a.transformEnabled||!a._addedToDOM){var d=Quark.cssPrefix,e=d+"TransformOrigin";d+="Transform";c=c.style;if(!c.display||a.propChanged("visible","alpha"))c.display=!a.visible||a.alpha<=0?"none":"";if(!c.opacity||a.propChanged("alpha"))c.opacity=a.alpha;if(!c.backgroundPosition||a.propChanged("rectX","rectY"))c.backgroundPosition=-a.rectX+
"px "+-a.rectY+"px";if(!c.width||a.propChanged("width","height"))c.width=a.width+"px",c.height=a.height+"px";if(!c[e]||a.propChanged("regX","regY"))c[e]=a.regX+"px "+a.regY+"px";if(!c[d]||a.propChanged("x","y","regX","regY","scaleX","scaleY","rotation"))e=Quark.supportTransform3D?b(a,!0):b(a,!1),c[d]=e;if(!c.zIndex||a.propChanged("_depth"))c.zIndex=a._depth;if(a.mask!=null)c[Q.cssPrefix+"MaskImage"]=a.mask.getDrawable(this).style.backgroundImage,c[Q.cssPrefix+"MaskRepeat"]="no-repeat",c[Q.cssPrefix+
"MaskPosition"]=a.mask.x+"px "+a.mask.y+"px"}};h.prototype.hide=function(a){a.getDrawable(this).style.display="none"};h.prototype.remove=function(a){var b=a.getDrawable(this),c=b.parentNode;c!=null&&c.removeChild(b);a._addedToDOM=!1}}else trace("Warn: DOMContext requires css transfrom support.")})();
